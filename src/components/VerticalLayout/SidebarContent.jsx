        ...
        <div id="sidebar-menu">
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            {/* <li>
              <li>
                ...
                <ul className="sub-menu" aria-expanded="false">
                  ...
                  <li>
                    <Link to="/product">{props.t("Product")}</Link>
                  </li>
                  <li>
                    <Link to="/createproject">{props.t("Create Project")}</Link>
                  </li>
            ...
            <li>
              ...
              <ul className="sub-menu" aria-expanded="false">
                <li>
                  <Link to="/projects-grid">{props.t("Products Grid")}</Link>
                </li>
                <li>
                  <Link to="/projects-list">{props.t("Products List")}</Link>
                </li>
                {/* <li>
